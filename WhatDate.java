//A program that inputs date and outputs what day of the week.
//You only need to pay attention to the formulas and processing codes that require a leap year.
...
class WhatDate{
	public static void main(String[] args){
		...
		if((year-1900)%4==0 && (month==1 || month==2))   //leap year
			Total_Days-=1;
